...
@Component({
  ...
  templateUrl: './enrollmentelementary.component.html'
})
export class EnrollmentElementaryComponent implements AfterViewInit {
    ...
    constructor(private _enrollService:EnrollmentService, private _router:Router,public dialog: MatDialog) {
